...
class ConcatHead(nn.Module):
    ...
    def forward(self, x):
        ...
        # Shape changes from [N, 4, 8400] to [N, 4, 16800]
        ...
        """FILTER"""
        """Define label which you want remove"""
        # label_remove = [5, 6, 7, 8, 9, 10, 11, 12, 16, 17, 18, 21, 24, 28, 33, 35, 36, 37, 38, 39, 42, 46, 49, 51, 52, 53, 63, 65, 67, 69, 70, 71, 
        #                 72, 73, 75, 76, 78, 79, 81, 84, 86, 87, 88, 89, 90, 91, 92, 95, 96, 98, 99, 102, 105, 106, 108, 115, 117, 119, 120, 125, 126, 
        #                 131, 132, 139, 140, 142, 143, 146, 151, 152, 154, 158, 160, 163, 166, 167, 169, 171, 174, 176, 178, 179, 184, 186, 190, 192, 
        #                 195, 199, 205, 206, 207, 209, 210, 213, 215, 216, 219, 221, 223, 224, 225, 226, 227, 229, 233, 235, 239, 246, 251, 253, 255, 
        #                 256, 257, 258, 259, 260, 261, 262, 263, 264, 265, 266, 267, 268, 269, 270, 271, 273, 276, 277, 279, 282, 284, 285, 287, 288, 
        #                 297, 300, 302, 305, 306, 307, 311, 312, 313, 315, 316, 319, 320, 321, 322, 323, 324, 326, 327, 333, 334, 336, 340, 341, 342, 
        #                 343, 344, 346, 347, 354, 356, 358, 359, 361, 362, 364, 365, 366, 370, 371, 372, 373, 374, 375, 379, 381, 387, 389, 391, 393, 
        #                 398, 399, 400, 401, 402, 404, 407, 409, 411, 412, 414, 416, 417, 418, 421, 422, 425, 427, 430, 433, 440, 443, 444, 445, 446, 
        #                 448, 451, 452, 454, 459, 465, 466, 468, 469, 470, 472, 473, 474, 479, 482, 486, 487, 488, 491, 495, 496, 497, 500, 501, 507, 
        #                 508, 518, 519, 521, 522, 523, 532, 534, 540, 544, 546, 548, 549, 550, 553, 554, 558, 560, 561, 563, 564, 566, 567, 571, 578, 
        #                 579, 581, 586, 589, 592, 594, 596, 597, 598, 599, 600]
        label_remove = [305, 247, 241]
        class_remove = [value + 4 for value in label_remove]
        # class_remove = []
